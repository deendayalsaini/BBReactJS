...
(function($){
    ...
    $.fn.multiselect = function( options ){
        var defaults = {
            ...
            selectAll     : false, // add Unselect All option
        ...
        return this.each(function(){
            ...
            // add global Unselect All options
            if( options.selectAll ) {
                optionsList.before('<a href="#" class="ms-selectall global">Unselect All</a>');

                var globalSelectAll = optionsWrap.find('.ms-selectall.global');
            }

            // handle Unselect All option
            ...
            $(this).children().each(function(){
                ...
                if( this.nodeName == 'OPTGROUP' ) {
                    ...
                    if( options.selectGroup ) {
                        container.append('<a href="#" class="ms-selectall">Unselect All</a>');
                    }
            ...
            var updatePlaceholderText = function(){
                ...
                if( copyWidth > placeWidth ) {
                    placeholder.text( selOpts.length + ' ' +options.placeholder );
                }
