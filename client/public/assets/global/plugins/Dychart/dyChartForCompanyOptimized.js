...
$(window).load(function () {
    ...
    //                arrValueRange.push(gs[0].getValue(i, 2).toString().split(",")[1]); //11WMA
    ...
    try {
        ...
        //        DAILYData.push([new Date('Feb 02, 2016 09:07:49'), 1266.80, 100.00]);
        //        DAILYData.push([new Date('Feb 02, 2016 09:15:01'), 1275.00, 100.00]);
        //        DAILYData.push([new Date('Feb 02, 2016 09:15:17'), 1271.95, 100.00]);
        //        DAILYData.push([new Date('Feb 02, 2016 09:15:37'), 1267.35, 100.00]);
        //        DAILYData.push([new Date('Feb 02, 2016 09:15:51'), 1272.40, 100.00]);
        //        DAILYData.push([new Date('Feb 02, 2016 14:40:07'), 1275.35, 100.00]);
        //        DAILYData.push([new Date('Feb 02, 2016 14:40:25'), 1275.95, 100.00]);
        //        DAILYData.push([new Date('Feb 02, 2016 14:40:30'), 1275.70, 100.00]);

        //DAILYData.push([new Date('Feb 03, 2016 16:00:00'), null, null]);
        //alert(DAILYData.length);

        var vlabel = ['TIME', 'ACC1', 'ASIANPAINT1'];
        var data = DAILYData;
        ...
        setInterval(function () {
            ...
            DAILYData1.splice(DAILYData1.length - 1, 0, [new Date(CDATETIME), CPRICE]);
            g.updateOptions({ 'file': DAILYData1 });
