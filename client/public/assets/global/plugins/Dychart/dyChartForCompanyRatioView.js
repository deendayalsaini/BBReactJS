...
$(window).load(function () {
    ...
    function zoomGraphX(applyValueRange, ncount, IsMonth) {
        ...
        /*Max Data and Min Date*/
        var min_data_x_Date = new Date(min_data_x);
        var max_data_x_Date = new Date(max_data_x);
        var d = new Date(max_data_x);
        if (IsMonth == 'Y') { d.setMonth(d.getMonth() - ncount); } else { d.setDate(d.getDate() - ncount); } //ncount: no of months.
        ...
        for (var i = record_count; i >= 0; i--) {
            ...
            if (tempDate - d > 0) {
                ...
                //Range Value 
                arrValueRange_y.push(gs[0].getValue(i, 1).toString().split(",")[1]); //Price
                arrValueRange_y.push(gs[0].getValue(i, 2).toString().split(",")[1]); //50DMA
                arrValueRange_y.push(gs[0].getValue(i, 3).toString().split(",")[1]); //200DMA
                arrValueRange_y2.push(gs[0].getValue(i, 4).toString().split(",")[1]); //PE
            }
            else { }
        }
        ...
        if (arrValueRange_y.length > 0) {
            y_MinValueRange = arrValueRange_y[arrValueRange_y.length - 1];
            y_MaxValueRange = arrValueRange_y[0];
        }
        ...
        var startVal = Number(Number(y_MinValueRange) - (Number(y_MinValueRange) * 0.05));
        var endVal = Number(Number(y_MaxValueRange) + (Number(y_MaxValueRange) * 0.05));

        var y2_startVal = Number(y2_MinValueRange);
        var y2_endVal = Number(y2_MaxValueRange + 1);

        // alert(y2_startVal + " " + y2_endVal);
        ...
        if (applyValueRange == "Y") {
            gs[0].updateOptions({
                ...
                axes: {
                    y2: {
                        valueRange: [y2_startVal, y2_endVal]
                    },
                    y: {
    ...
    $("#btn1Day").click(function () {
        ...
        for (var i = record_count; i >= 0; i--) {
            ...
            if (tempDate - d > 0) {
                ...
                arrValueRange_y.push(gs[0].getValue(i, 2).toString().split(",")[1]); //50DMA
                arrValueRange_y.push(gs[0].getValue(i, 3).toString().split(",")[1]); //200DMA
                //arrValueRange_y.push(gs[0].getValue(i, 4).toString().split(",")[1]); //200DMA
