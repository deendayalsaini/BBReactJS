$(document).ready(function () {
    ...
    function Grapg1(ObjLoadFirst) {
       ...
       CompanyData, {
           ...
           //ylabel: 
           legend: 'always',
           colors: ['#468BC9', 'brown', '#008000', '#006666'],
           rangeSelectorHeight: 30,
           rangeSelectorPlotStrokeColor: '#1A5488',
           rangeSelectorPlotFillColor: '#D6E7F2',
           labels: vlabels, //['Date', 'NAV', 'BenchMark', 'Y3', 'Y4'],
           visibility: vvisibility, //[true, true],
           ylabel: 'NAV',
           ...
           series:
                vseriesJSON, // {'NAV': { axis: 'y1',fillGraph: true},'NAV1':{axis: 'y1'},'BenchMark': {axis: 'y2'},'Y3': {axis: 'y2'},'Y4': {axis: 'y2'}},
           axes: {
               x: {
    ...
    $("#btn1Week").click(function () {
        ...
        for (var i = record_count; i >= 0; i--) {
            ...
            if (tempDate - d > 0) {
                ...
                arrValueRange.push(gs[0].getValue(i, 1).toString().split(",")[1]);
            }
            else {
        ...
        //Value Range Sorting or Min and Max Value
