...
import IssuserQuarterlyRatioAnalytics from './RatiosAnalytics/IssuserQuarterlyRatioAnalytics';
...
class RatiosAnalytics extends Component {
  constructor(props) {
    super(props);
    ...
    <div class="page-content-inner">
      <div class="mt-content-body">
               <div class="tab_container">
                      ...
                      <input id="QhdDeal_Issuer" type="hidden" value={this.props.match.params.id} />
...
export default RatiosAnalytics;
